...
convert_xfm -omat ${RESULTSDIR}/mT1_day1_2_diff_pre_bbr.mat -concat ${DIFFDIR_PRE}/xfms/T1_2_diff_bbr.mat ${T1XFMSDIR}/mT1_day1_2_pre_6dof.mat 
...
applywarp -i ${ANALYSISDIR}/${DAY1}/anat/T1_lesion_mask_filled -r ${ANALYSISDIR}/${PRE}/diffusion/mean_b0_unwarped -o ${ANALYSISDIR}/${PRE}/diffusion/Kwon_ROIs_ants/T1_lesion_mask_filled2diff --interp=trilinear --premat=${ANALYSISDIR}/${MYSUB_PREFIX}_longitudinal_xfms/mT1_day1_2_diff_pre_bbr.mat

...
do
echo test
#antsApplyTransforms -d 3 -i ${ROIDIR}/${ROI}.nii.gz -r ${FSLDIR}/data/standard/MNI152_T1_1mm.nii.gz -o ${MAINDIR}/analysis/${MYSUB}/diffusion/Kwon_ROIs_ants/${ROI}.nii.gz -t ${MAINDIR}/analysis/${MYSUB}/anat/xfms/ants/bet/MNI_1mm_2_mT10GenericAffine.mat -t ${MAINDIR}/analysis/${MYSUB}/anat/xfms/ants/bet/MNI_1mm_2_mT11Warp.nii.gz
...
do
echo test
#antsApplyTransforms -d 3 -i ${ROIDIR}/${ROI}.nii.gz -r ${FSLDIR}/data/standard/MNI152_T1_1mm.nii.gz -o ${MAINDIR}/analysis/${MYSUB}/diffusion/Kwon_ROIs_ants/${ROI}.nii.gz -t ${MAINDIR}/analysis/${MYSUB}/anat/xfms/ants/MNI_1mm_2_mT10GenericAffine.mat -t ${MAINDIR}/analysis/${MYSUB}/anat/xfms/ants/MNI_1mm_2_mT11Warp.nii.gz
...
do
#THIS WORKS BUT THE FLIRT CALL BELOW PUTS THE ROIS in the WRONG SPOT????
flirt -applyxfm -init ${MAINDIR}/analysis/${MYSUB}/diffusion/xfms/T1_2_diff_bbr.mat -in ${MAINDIR}/analysis/${MYSUB}/anat/xfms/ants/bet/mT1_brain -out ${MAINDIR}/analysis/${MYSUB}/diffusion/Kwon_ROIs_ants/test -ref ${MAINDIR}/analysis/${MYSUB}/diffusion/mean_b0_unwarped -interp nearestneighbour
fsleyes ${MAINDIR}/analysis/${MYSUB}/diffusion/Kwon_ROIs_ants/test ${MAINDIR}/analysis/${MYSUB}/diffusion/mean_b0_unwarped

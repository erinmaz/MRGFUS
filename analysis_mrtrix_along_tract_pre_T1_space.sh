...
#NEED TO TEST THIS
flirt -in ${DIFFDIR}/rois_tracking_atlasROIs_300718/RN_standard_1mm_${TREATMENTSIDE}_dilM.nii.gz -ref ${MAINDIR}/${MYSUB_PRE}/anat/T1 -applyxfm -init ${MAINDIR}/${MYSUB_PRE}/diffusion/xfms/diff_2_T1_bbr.mat -interp nearestneighbour -out ${WORKDIR}/RN_standard_1mm_${TREATMENTSIDE}_dilM_T1space
...
#Would be nice to precisely mark where lesion is on along-tract figure as well.

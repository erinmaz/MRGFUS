...
fslmaths ${MYDIR}/diffusion/Kwon_ROIs/dentate_${TREATED_DENTATE}_dil_thalterm/fdt_paths -roi ${treated_dentate_x} ${diffx} ${treated_dentate_y} ${diffy} ${treated_dentate_z} ${diffz} 0 1 ${MYDIR}/diffusion/Kwon_ROIs/dentate_${TREATED_DENTATE}_dil_thalterm/fdt_paths_dentate2SCP_decus

fslmaths ${MYDIR}/diffusion/Kwon_ROIs/dentate_${TREATED_DENTATE}_dil_thalterm/fdt_paths -roi ${decus_x} ${diff2x} ${decus_y} ${diff2y} ${decus_z} ${diff2z} 0 1 ${MYDIR}/diffusion/Kwon_ROIs/dentate_${TREATED_DENTATE}_dil_thalterm/fdt_paths_SCP_decus2lesion
else
fslmaths ${MYDIR}/diffusion/Kwon_ROIs/dentate_${TREATED_DENTATE}_dil_thalterm/fdt_paths -roi ${decus_x} ${diffx} ${treated_dentate_y} ${diffy} ${treated_dentate_z} ${diffz} 0 1 ${MYDIR}/diffusion/Kwon_ROIs/dentate_${TREATED_DENTATE}_dil_thalterm/fdt_paths_dentate2SCP_decus
...
#fsleyes ${MYDIR}/diffusion/mean_b0_unwarped ${MYDIR}/diffusion/Kwon_ROIs/dentate_${TREATED_DENTATE}_dil_thalterm/fdt_paths  ${MYDIR}/diffusion/Kwon_ROIs/dentate_${TREATED_DENTATE}_dil_thalterm/fdt_paths_dentate2SCP_decus_bin -cm "Red" ${MYDIR}/diffusion/Kwon_ROIs/dentate_${TREATED_DENTATE}_dil_thalterm/fdt_paths_SCP_decus2lesion_bin -cm "Blue" 
 
#untreated tract
untreated_dentate_coords=`fslstats ${MYDIR}/diffusion/Kwon_ROIs/dentate_${UNTREATED_DENTATE}_dil -C`
untreated_dentate_x=`echo $untreated_dentate_coords | awk '{print $1}'`
untreated_dentate_y=`echo $untreated_dentate_coords | awk '{print $2}'`
untreated_dentate_z=`echo $untreated_dentate_coords | awk '{print $3}'`
...
diffx=`echo $decus_x - $untreated_dentate_x | bc`
diffx=`echo ${diffx#-}` #abs value
diffy=`echo $decus_y - $untreated_dentate_y | bc`
diffz=`echo $decus_z - $untreated_dentate_z | bc`

lesion_coords=`fslstats ${MYDIR}/diffusion/T1_lesion_mask_filled2MNI_1mm_xswap_2diff_bin -C`
...
if [ $UNTREATED_DENTATE = "R" ]; then

fslmaths ${MYDIR}/diffusion/Kwon_ROIs/dentate_${UNTREATED_DENTATE}_dil_thalterm/fdt_paths -roi ${untreated_dentate_x} ${diffx} ${untreated_dentate_y} ${diffy} ${untreated_dentate_z} ${diffz} 0 1 ${MYDIR}/diffusion/Kwon_ROIs/dentate_${UNTREATED_DENTATE}_dil_thalterm/fdt_paths_dentate2SCP_decus

fslmaths ${MYDIR}/diffusion/Kwon_ROIs/dentate_${UNTREATED_DENTATE}_dil_thalterm/fdt_paths -roi ${decus_x} ${diff2x} ${decus_y} ${diff2y} ${decus_z} ${diff2z} 0 1 ${MYDIR}/diffusion/Kwon_ROIs/dentate_${UNTREATED_DENTATE}_dil_thalterm/fdt_paths_SCP_decus2lesion

else
fslmaths ${MYDIR}/diffusion/Kwon_ROIs/dentate_${UNTREATED_DENTATE}_dil_thalterm/fdt_paths -roi ${decus_x} ${diffx} ${untreated_dentate_y} ${diffy} ${untreated_dentate_z} ${diffz} 0 1 ${MYDIR}/diffusion/Kwon_ROIs/dentate_${UNTREATED_DENTATE}_dil_thalterm/fdt_paths_dentate2SCP_decus
...
#fsleyes ${MYDIR}/diffusion/mean_b0_unwarped ${MYDIR}/diffusion/Kwon_ROIs/dentate_${UNTREATED_DENTATE}_dil_thalterm/fdt_paths  ${MYDIR}/diffusion/Kwon_ROIs/dentate_${UNTREATED_DENTATE}_dil_thalterm/fdt_paths_dentate2SCP_decus_bin -cm "Red" ${MYDIR}/diffusion/Kwon_ROIs/dentate_${UNTREATED_DENTATE}_dil_thalterm/fdt_paths_SCP_decus2lesion_bin -cm "Blue" 


#convert all sub-tracts T1 space for longitudinal analysis

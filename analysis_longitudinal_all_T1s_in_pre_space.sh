...
flirt -in ${ANATDIR_MONTH12}/mT1_brain -ref ${ANATDIR_PRE}/mT1_brain -out ${RESULTSDIR}/mT1_brain_month12_2_pre_6dof -omat ${RESULTSDIR}/mT1_brain_month3_2_pre_6dof.math -dof 6

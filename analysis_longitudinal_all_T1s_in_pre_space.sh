...
flirt -in ${ANATDIR_MONTH3}/mT1_brain -ref ${ANATDIR_PRE}/mT1_brain -out ${RESULTSDIR}/mT1_brain_month3_2_pre_6dof -omat ${RESULTSDIR}/mT1_month3_2_pre_6dof.mat -dof 6

...
fslsplit ${ANALYSISDIR}/${MYSUB}/diffusion/dti_fow ${ANALYSISDIR}/${MYSUB}/diffusion/dti_fow_ -t
#manually based on artifacts, mostly intra-volume motion
remove_vols_dti_fow=(3 14 16 18 21 22 33 34 43 44 45 )
vol26 is borderline
23% of volumes
remove_vols_dti_rev 
4 is borderline 

...
do
applywarp -i /Users/erin/Desktop/Projects/MRGFUS/analysis/${pre}/anat/first/first_${side}_thal -w /Users/erin/Desktop/Projects/MRGFUS/analysis/9001_SH_longitudinal_xfms_T1/pre_to_${tp}_warp -o /Users/erin/Desktop/Projects/MRGFUS/analysis/${pre}/anat/first/first_${side}_thal_to_${tp} -r /Users/erin/Desktop/Projects/MRGFUS/analysis/${!tp}/anat/mT1

fslmaths /Users/erin/Desktop/Projects/MRGFUS/analysis/${pre}/anat/first/first_${side}_thal_to_day1 -thr 0.5 -bin /Users/erin/Desktop/Projects/MRGFUS/analysis/${pre}/anat/first/first_${side}_thal_to_${tp}_thr_bin

applywarp -i /Users/erin/Desktop/Projects/MRGFUS/analysis/${pre}/anat/first/first_${side}_thal -w /Users/erin/Desktop/Projects/MRGFUS/analysis/9001_SH_longitudinal_xfms_T1/pre_to_${tp}_warp -o /Users/erin/Desktop/Projects/MRGFUS/analysis/${pre}/anat/first/first_${side}_thal_to_${tp}_nn -r /Users/erin/Desktop/Projects/MRGFUS/analysis/${!tp}/anat/mT1 --interp=nn

...
echo REGIONS >> regions.txt
 ...
 echo left_dentate_waypoint >> regions.txt
 echo right_dentate_tract >> regions.txt
 echo right_dentate_waypoint >> regions.txt
...
fslstats /Users/erin/Desktop/Projects/MRGFUS/analysis/${MYSUB}/diffusion/Kwon_ROIs/optic_chiasm -V | awk '{print $2}' >> ${MYSUB}.txt
 ...
 fslstats /Users/erin/Desktop/Projects/MRGFUS/analysis/${MYSUB}/diffusion/Kwon_ROIs/dentate_L_dil_exclude2_corticalwaypoint/fdt_paths -V | awk '{print $2}' >> ${MYSUB}.txt
 more /Users/erin/Desktop/Projects/MRGFUS/analysis/${MYSUB}/diffusion/Kwon_ROIs/dentate_L_dil_exclude2_corticalwaypoint/waytotal >> ${MYSUB}.txt
 fslstats /Users/erin/Desktop/Projects/MRGFUS/analysis/${MYSUB}/diffusion/Kwon_ROIs/dentate_R_dil_exclude2_corticalwaypoint/fdt_paths -V | awk '{print $2}' >> ${MYSUB}.txt
 more /Users/erin/Desktop/Projects/MRGFUS/analysis/${MYSUB}/diffusion/Kwon_ROIs/dentate_R_dil_exclude2_corticalwaypoint/waytotal >> ${MYSUB}.txt

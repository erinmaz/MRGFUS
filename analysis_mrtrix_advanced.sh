...
tckgen -algorithm SD_STREAM -seed_image ${DIFFDIR}/rois_tracking_atlasROIs_300718/RN_standard_1mm_${TREATMENTSIDE}.nii.gz -include ${DIFFDIR}/rois_tracking_atlasROIs_300718/harvardoxford-cortical_prob_Precentral+Juxtapositional_${TREATMENTSIDE}.nii.gz ${WORKDIR}/fod.nii.gz ${WORKDIR}/rtt.tck

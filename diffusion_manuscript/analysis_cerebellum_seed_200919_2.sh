...
fsleyes ${QADIR}/${r}/diffusion/mean_b0_unwarped ${WORKDIR}/${CC_MASK_NAME} &
# GENERATE STREAMLINES
tckedit -exclude ${WORKDIR}/${CC_MASK_NAME}.nii.gz ${WORKDIR}/drtt.tck ${WORKDIR}/drtt_exclude_cc.tck -force

# CONVERT STREAMLINES TO NII
tckmap -template ${QADIR}/${r}/diffusion/mean_b0_unwarped.nii.gz ${WORKDIR}/drtt_exclude_cc.tck ${WORKDIR}/drtt_exclude_cc.nii.gz -force

red_streamlines=`fslstats ${WORKDIR}/drtt_exclude_cc -k ${WORKDIR}/${RED_MASK_NAME} -R`
thalamus_streamlines=`fslstats ${WORKDIR}/drtt_exclude_cc -k ${WORKDIR}/${THALAMUS_MASK_NAME} -R`

fsleyes ${QADIR}/${r}/diffusion/mean_b0_unwarped ${WORKDIR}/drtt_exclude_cc &

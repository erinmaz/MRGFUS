...
#echo ${OUTFILE}_${side}_d2s
echo $1 >> ${OUTFILE}_${side}_d2s
echo $1 >> ${OUTFILE}_${side}_s2l

vol_d2s=`fslstats ${MYDIR}/diffusion/Kwon_ROIs_ants/dentate_${TREATED_DENTATE}_dil_thalterm/fdt_paths_bin_nolesion_untreated_dentate2SCP_decus_bin2T1_bin -V | awk '{print $2}'`

vol_s2l=`fslstats ${MYDIR}/diffusion/Kwon_ROIs_ants/dentate_${TREATED_DENTATE}_dil_thalterm/fdt_paths_bin_nolesion_untreated_SCP_decus2lesion2T1_bin -V | awk '{print $2}'`
...
do
fslstats ${MAINDIR}/${1}_diffusion_longitudinal/dti_in_pre_T1_space_220219/${measure}_${TP} -k ${MYDIR}/diffusion/Kwon_ROIs_ants/dentate_${TREATED_DENTATE}_dil_thalterm/fdt_paths_bin_nolesion_untreated_dentate2SCP_decus_bin2T1_bin -M >> ${OUTFILE}_${side}_d2s
fslstats ${MAINDIR}/${1}_diffusion_longitudinal/dti_in_pre_T1_space_220219/${measure}_${TP} -k ${MYDIR}/diffusion/Kwon_ROIs_ants/dentate_${TREATED_DENTATE}_dil_thalterm/fdt_paths_bin_nolesion_untreated_SCP_decus2lesion2T1_bin -M >> ${OUTFILE}_${side}_s2l

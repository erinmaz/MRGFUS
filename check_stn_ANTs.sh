...
antsApplyTransforms -d 3 -i ${LESIONDIR}/${MYSUB}-${EXAM}/anat/T1_lesion_mask_filled.nii.gz -r ${FSLDIR}/data/standard/MNI152_T1_1mm.nii.gz -o T1_lesion_filled_mask_2_MNI152_T1_1mm.nii.gz -t [MNI_1mm_2_mT10GenericAffine.mat,1] -t MNI_1mm_2_mT11InverseWarp.nii.gz

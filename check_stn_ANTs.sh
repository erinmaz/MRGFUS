...
for MYSUB in 9001_SH 9002_RA 9004_EP 9005_BG 9006_EO 9009_CRB 9011_BB 9013_JD 9021_WM 
...
antsApplyTransforms -d 3 -i ${LESIONDIR}/${MYSUB}-${day1_exam}/anat/T1_lesion_mask_filled.nii.gz -r ${FSLDIR}/data/standard/MNI152_T1_1mm.nii.gz -o T1_lesion_filled_mask_2_MNI152_T1_1mm.nii.gz -t [MNI_1mm_2_mT10GenericAffine.mat,1] -t MNI_1mm_2_mT11InverseWarp.nii.gz -n Linear
fslmaths T1_lesion_filled_mask_2_MNI152_T1_1mm -thr 0.5 -bin T1_lesion_filled_mask_2_MNI152_T1_1mm
